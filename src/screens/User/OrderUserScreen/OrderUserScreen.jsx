...
const OrderUserScreen = () => {
    ...
    return (
        <Box sx={{ height: '60rem', backgroundColor: 'white' }}>
            {listProductsInOrder.length > 0 ?
                (
                    listProductsInOrder.map((product, index) => {
                        return (
                                ...
                                <Box sx={{ display: 'flex', flexDirection: 'row' }}>
                                    ...
                                    <Box>
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center', pl: 1, pb: 1 }}>
                                            ...
                                            <Button variant="contained" onClick={() => handleClickOpen(product.id)}>Rating</Button>
                                            <div>
